...
$string['shortname_help'] = 'Short name of the source for use in API and integrations. Must be unique. Only letters, numbers, hyphens and underscores are allowed.';
$string['shortname_already_exists'] = 'A source with this short name already exists.';
