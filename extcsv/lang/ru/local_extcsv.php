...
$string['mapcolumns'] = 'Настроить маппинг колонок';
$string['selectcolumns'] = 'Выберите колонки для импорта';
$string['columntype'] = 'Тип колонки';
$string['shortname'] = 'Короткое имя';
$string['shortname_help'] = 'Короткое имя источника для использования в API и интеграциях. Должно быть уникальным. Разрешены только буквы, цифры, дефисы и подчёркивания.';
$string['shortname_already_exists'] = 'Источник с таким коротким именем уже существует.';
$string['slotassigned'] = 'Назначен слот';
$string['fieldlimitreached'] = 'Достигнут лимит полей: {$a->type} (макс: {$a->max}, выбрано: {$a->selected})';
$string['mappingsaved'] = 'Маппинг колонок успешно сохранён';
$string['availableslots'] = 'Доступно слотов: {$a->used}/{$a->max}';
$string['columnsnotconfigured'] = 'Маппинг колонок не настроен. Пожалуйста, настройте колонки перед импортом данных.';
$string['configurecolumnsfirst'] = 'Настроить колонки';
$string['nocolumnsmapping'] = 'Колонки не настроены. Перейдите на страницу предпросмотра для настройки маппинга колонок.';
$string['columnsmappingrequired'] = 'Требуется настройка маппинга колонок перед импортом данных';
$string['fieldlimits'] = 'Лимиты полей';
$string['type_text'] = 'Текст';
$string['type_int'] = 'Целое число';
$string['type_float'] = 'Дробное число';
$string['type_bool'] = 'Логическое';
